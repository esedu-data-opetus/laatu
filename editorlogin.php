...
<head>
  <meta charset="utf-8">
  <title>Editori kirjautuminen</title>
...
<body>
  ...
  <?php
    ...
    $sql = "SELECT * from users WHERE username LIKE '{$username}' AND password LIKE '{$password}' AND rooli>2 LIMIT 1 ";
    $result = $conn->query($sql);
    if (!$result->num_rows == 1) {
        echo "<a href='editorlogin.php'>Pääsy evätty</p>";
    } else {
